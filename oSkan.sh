#!/bin/bash
# oSkan  v1.3
# Release on 24/04/2022
# © Copyright ~ JayCyberSec
...
printf "\t${f6} /___________________\   ${f2}oSkan ©️ＪＡＹ "

echo ""
echo "${f3}Author     : ${f7}JayCyberSecurity "
echo "${f3}Country       : ${f7}(🇰🇪)KENYA "
echo "${f3}Disclaimer : ${f7}I am not responsible for any damage caused by the tool. Attacking targets without consent is illegal!"
}

# menu
banner
echo ""
echo "${f2}[ ${f1}oSkan  Menu ${f2}]"
echo ""
echo "   ${f2}[${f1}1${f2}] ${f6}𝓛𝐹𝒾 ${f5}Scanner           ${f2}[${f1}5${f2}] ${f6}𝐹iles  ${f5}Scanner"
echo "   ${f2}[${f1}2${f2}] ${f6}𝑅𝐹𝒾 ${f5}Scanner           ${f2}[${f1}6${f2}] ${f6}𝕵oomla Components  ${f5}Scanner"
echo "   ${f2}[${f1}3${f2}] ${f6}𝑅c𝑒 ${f5}Scanner           ${f2}[${f1}7${f2}] ${f6}Admin Page  ${f5}Finder"
echo "   ${f2}[${f1}4${f2}] ${f6}𝓓irectory ${f5}Scanner        ${f2}[${f1}8${f2}] ${f6}Shell  ${f5}Scanner"
echo ""
echo -e ${f6}"┌─[${f1}oSkan ${f6}]──[${f1}ＪＡＹ${f6}]"
read -p "└─────► " cras;
echo "${f1}Ex: ${f7}http://google.com"
...
if [[ $cras == 1 ]]; then
	...
	echo "${f2}[${f1}X${f2}]${f4} WHAT DO YOU THINK YOU ARE DOING!"
fi
##########################################
